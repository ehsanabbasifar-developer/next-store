  ...
  return (
    <div className="flex flex-col min-h-screen font-sans antialiased">
      <Head>
        ...
        <meta name="description" content="Welcome to MyStore, your one-stop shop for high-quality products." />
      ...
      <main className="flex-grow pt-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto py-8">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16">
            {/* Category Card 1 */}
            <a href="/products" className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg w-full md:w-1/3 transition-transform duration-300 hover:scale-105">
              <img src="https://via.placeholder.com/200" alt="Apparel" className="w-32 h-32 rounded-full mb-4 object-cover" />
            ...
            {/* Category Card 2 */}
            <a href="/products" className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg w-full md:w-1/3 transition-transform duration-300 hover:scale-105">
              <img src="https://via.placeholder.com/200" alt="Electronics" className="w-32 h-32 rounded-full mb-4 object-cover" />
            ...
            {/* Category Card 3 */}
            <a href="/products" className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-lg w-full md:w-1/3 transition-transform duration-300 hover:scale-105">
              <img src="https://via.placeholder.com/200" alt="Home Goods" className="w-32 h-32 rounded-full mb-4 object-cover" />
