...
export default function LoginPage() {
  return (
    <div className="flex flex-col min-h-screen font-sans antialiased">
      <Head>
        <title>Account Login - MyStore</title>
        <meta name="description" content="Log in to your existing MyStore account." />
      </Head>
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-100">
        <div className="max-w-md w-full space-y-8 bg-white p-10 shadow-2xl rounded-xl">
          ...
          {/* لینکی برای انتقال به صفحه Sign In (ثبت نام) */}
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Don't have an account yet? 
              <a href="/signin" className="font-medium text-blue-600 hover:text-blue-500 ml-1 transition-colors">
                Sign Up
              </a>
            </p>
          </div>
