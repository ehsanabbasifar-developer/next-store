  ...
  return (
    <div className="flex flex-col min-h-screen font-sans antialiased">
      <Head>
        ...
        <meta name="description" content="Sign up for a new account to start shopping." />
      </Head>
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-100">
        <div className="max-w-md w-full space-y-8 bg-white p-10 shadow-2xl rounded-xl">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors"
                />
              </div>
          ...
          {/* لینکی برای انتقال به صفحه Login */}
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Already have an account? 
              <a href="/login" className="font-medium text-blue-600 hover:text-blue-500 ml-1 transition-colors">
                Log In
              </a>
            </p>
          </div>
