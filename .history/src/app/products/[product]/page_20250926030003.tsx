    ...
    <div className="flex flex-col min-h-screen font-sans antialiased">
      ...
      <main className="flex-grow py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 mt-13">
        <div className="max-w-7xl mx-auto">
          {/* Main Grid Container with controlled image size */}
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-start">
            {/* Image Section - Limited Size */}
            <div className="flex justify-center lg:justify-end">
              <div className="max-w-md w-full overflow-hidden rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
                <img
                  src={data.image}
                  alt={data.title}
