  ...
  if (!data) {
    return (
      <div className="text-center py-20 bg-gray-50">
        <h1 className="text-4xl font-bold text-gray-900">محصول یافت نشد</h1>
        <p className="mt-4 text-gray-600">
          داده محصول از سرور دریافت نشد، لطفاً مجدداً تلاش کنید.
        </p>
      </div>
    );
  }
      ...
      <main className="flex-grow py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-start">
            {/* بخش تصویر محصول - با محدودیت اندازه */}
            ...
            <div className="mt-12 lg:mt-0 lg:p-4">
              ...
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-gray-900" تحات
                </h3>
