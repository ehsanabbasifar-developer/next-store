...
export default function ProductLayout({ product }: Props) {
  return (
    <Link href={``} className="flex flex-col justify-between items-center p-6 bg-white rounded-lg shadow-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 transition-transform duration-300 hover:scale-105">
      <div>
        <img
          src={product.image}
          alt={product.title}
